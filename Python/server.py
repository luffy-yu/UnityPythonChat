# refer: https://gitlab.freedesktop.org/gstreamer/gst-examples/-/blob/1.18/webrtc/signalling/simple_server.py
...
class WebRTCSimpleServer(object):
    ...
    def run(self):
        ...
        # Websocket server
        wsd = websockets.serve(handler, self.addr, self.port, ssl=sslctx,
...
def main():
    ...
    parser.add_argument('--restart-on-cert-change', default=False, dest='cert_restart', action='store_true',
